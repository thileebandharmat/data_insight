...
class Insights:
    """This class contains the functions to create insight about a data"""
    ...
    def create_summary(source, output_path):
        ...
        src_dup_cnt = "Number of duplicate records in source is: " + str(len(source[source.duplicated(keep=False)])) + "\n\n"
